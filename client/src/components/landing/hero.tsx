          ...
          >
            <div className="space-y-4 md:space-y-6 text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl text-muted-foreground">
                Experience the power of AI-driven document management. Our cutting-edge platform saves up to 70% of time across the entire document lifecycle – from creation to signing.
              </p>
            </div>
